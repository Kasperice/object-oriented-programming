...
Fruit::Fruit(uint32_t amount, const std::string& name, uint32_t basePrice, Time* time, int32_t expiryDate)
    : Cargo(amount, name, basePrice, time), expiryDate_(expiryDate), currentExpiryDate_(expiryDate) {}
Fruit::~Fruit() {}
